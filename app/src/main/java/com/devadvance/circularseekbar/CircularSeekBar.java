...
public class CircularSeekBar extends View {
	 ...
	 * @param lockEnabled boolean value. True if the pointer should lock at zero and max, false if it should not.
	 */
	...
	*/
	 ...
	 * @param   isTouchEnabled boolean value. True if user touch input is to be accepted, false if user touch input is to be ignored.
	 */
